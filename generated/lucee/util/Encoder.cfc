component 
{
	...
	**/
	public string function DecodeFromURL( required string string){

		
		return DecodeFromURL( string=arguments.string);
	...
	**/
	public string function EncodeForCSS( required string string){
	...
	**/
	public string function EncodeForDN( required string string){
	...
	**/
	public string function EncodeForHTML( required string string){
	...
	**/
	public string function EncodeForHTMLAttribute( required string string){
	...
	**/
	public string function EncodeForJavaScript( required string string){
	...
	**/
	public string function EncodeForLDAP( required string string){
	...
	**/
	public string function EncodeForURL( required string string){
	...
	**/
	public string function EncodeForXML( required string string){
	...
	**/
	public string function EncodeForXMLAttribute( required string string){
	...
	**/
	public string function EncodeForXPath( required string string){
